"""Hiring Manager Telegram Bot service for X5 Hiring Bootcamp."""
...
@app.post("/tg/hm/{secret}", response_model=WebhookResponse, tags=["webhook"])
async def telegram_webhook(secret: str, request: Request) -> WebhookResponse:
    """
    Telegram webhook endpoint for HM bot.
